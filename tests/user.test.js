...
describe("1 - Utilizando a rota '/users' ", () => {
  describe("ao tentar criar um novo usuário com sucesso", async () => {
    ...
    it.only('retorna Status HTTP 201 - "CREATED"', () => {
  ...
  describe("checa se o usuário está inserindo os inputs corretamente", () => {
    ...
    it("Verifica se 'displayName' foi inserido!", () => {
      let response;
      response = await chai.request(server)
      .post('/users')
      .send({
    ...
    it("Verifica se 'displayName' possui ao menos 8 caracteres!", () => {
      let response;
    ...
    it("Verifica se 'password' possui ao menos 6 caracteres!", () => {
      let response;
